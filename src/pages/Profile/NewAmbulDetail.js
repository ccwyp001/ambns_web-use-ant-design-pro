...
const extra = (
  <Row>
    <Col xs={24} sm={12}>
      ...
      <div className={styles.heading}>正常完成</div>
    </Col>
    <Col xs={24} sm={12}>
...
const description = (
  <DescriptionList className={styles.headerList} size="small" col="2">
    <Description term="调度员">曲丽丽</Description>
    <Description term="受理来源">电话呼救</Description>
    <Description term="受理时间">2017-07-07</Description>
    <Description term="呼叫类型">普通急救</Description>
    <Description term="呼叫原因">常规急救-创伤-跌倒</Description>
    <Description term="现场地址">玉环泰安路17号玉环泰安路17号玉环泰安路17号玉环泰安路17号</Description>
  </DescriptionList>
);
...
class AdvancedProfile extends Component {
  ...
  render() {
    ...
    const { profile, loading, match } = this.props;
    const { params } = match;
    ...
    return (
      <PageHeaderWrapper
        ...
        // tabList={tabList}
      >
        <Card title="出车进度" style={{ marginBottom: 24 }} bordered={false}>
